...
internal class ProductRatingRepositoryFactory : RepositoryFactory<ProductRating>
{
    internal override ProductRatingRepository Create(StoreContext dbContext) => new(dbContext);
}